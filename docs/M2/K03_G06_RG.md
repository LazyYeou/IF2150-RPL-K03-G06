...
Berikut merupakan kebutuhan non-fungsional yang telah disesuaikan dengan pemetaan kebutuhan pada Bab 2.3:
...
Berikut merupakan kebutuhan non-fungsional yang telah disesuaikan dengan parameter yang ada dan pemetaan kebutuhan pada Bab 2.3:
...
| KNF21 | R01, R12, R17 | Portability | Ketika pengguna mengakses platform untuk tahapan registrasi, membuat lowongan (A04), atau mengajukan penawaran , sistem harus mampu menampilkan tata letak antarmuka secara adaptif. |
