...
**Nama Use Case:** *Melakukan Registrasi dan Autentikasi*
...
**Skenario Alternatif 3: Autentikasi Gagal**

| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | Pengguna melakukan login dengan kredensial | Sistem memverifikasi kredensial dan menemukan ketidakcocokan data (email atau kata sandi salah) |
| 2 | Pengguna menekan tombol masuk | Sistem menampilkan pesan error kredensial tidak valid dan menolak akses masuk |
...
**Nama Use Case:** *Mencari dan Mengajukan Penawaran*

**Skenario Normal**

| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | Tenaga Kerja memasukkan parameter kategori atau keterampilan di kolom pencarian | Sistem memfilter dan hanya menampilkan daftar lowongan yang berstatus "Open" |
| 2 | Tenaga Kerja membuka salah satu lowongan | Sistem menampilkan halaman detail pekerjaan beserta tombol "Ajukan Penawaran" |
| 3 | Tenaga Kerja menekan "Ajukan Penawaran" dan mengonfirmasi pesan pengajuan | Sistem menyimpan data pengajuan (ID Tenaga Kerja, ID Lowongan, pesan penawaran, timestamp) ke basis data dan menampilkan notifikasi sukses |

<br>

**Skenario Alternatif 1: Akses Pengajuan Dibatasi**

| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | Tenaga Kerja (dengan status belum terverifikasi) membuka salah satu lowongan | Sistem menampilkan halaman detail pekerjaan tanpa menyediakan akses ke tombol "Ajukan Penawaran" |

<br>

**Skenario Alternatif 2: Hasil Pencarian Kosong**
...
**Skenario Alternatif 3: Membatalkan Pengajuan pada Tahap Konfirmasi**

| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | Tenaga Kerja memasukkan parameter pencarian | Sistem menampilkan daftar lowongan berstatus "Open" |
| 2 | Tenaga Kerja membuka salah satu lowongan dan menekan "Ajukan Penawaran" | Sistem menampilkan pop-up konfirmasi untuk mengirimkan pesan pengajuan |
| 3 | Tenaga Kerja menekan tombol batal pada pop-up | Sistem menutup pop-up, membatalkan pengajuan, dan kembali menampilkan halaman detail pekerjaan |
...
**Nama Use Case:** *Memberikan Rating dan Ulasan*
